...
import Imagesdesign from '../../components/Slidingdesign';
            ...
            <div className={`${styles.container} mx-[10%] mt-[15%]`}>
                ...
                <div className={styles.desc}>
                    ...
                    <h4 className='max-w-72 mb-5'>
                        <span>Safir Media Komunikasi menawarkan layanan 3D Design yang inovatif untuk memperkaya pengalaman acara Anda. Kami menciptakan visualisasi tiga dimensi yang realistis, mulai dari desain panggung, dekorasi, hingga tata ruang acara, disesuaikan dengan visi Anda..</span>
                    </h4>
                    <h4>
                        <span className="text-gray-400">Make It 3D</span>
                        <motion.span
                ...
                <div className="flex flex-col md:flex-row justify-between mb-[100px]">
                    <div className='w-96'>
                        ...
                        <h3 className='text-[2em] mb-8'>Visualisasi Kreatif</h3>
                        <h4>Kami menciptakan desain 3D realistis untuk panggung, dekorasi, dan tata ruang yang mencerminkan visi acara Anda.</h4>
                    </div>
                    <div className='w-96'>
                        <h4 className='text-gray-400 mb-8'>02</h4>
                        <div className="w-full h-[1px] bg-gray-400 mt-2 mb-8"></div>
                        <h3 className='text-[2em] mb-8'>Kustomisasi</h3>
                        <h4>Setiap desain disesuaikan dengan tema dan kebutuhan acara, dari pernikahan hingga pameran besar.</h4>
                    </div>
                    <div className='w-96'>
                        <h4 className='text-gray-400 mb-8'>03</h4>
                        <div className="w-full h-[1px] bg-gray-400 mt-2 mb-8"></div>
                        <h3 className='text-[2em] mb-8'>Teknologi Canggih</h3>
                        <h4>Menggunakan perangkat lunak 3D terkini untuk menghasilkan rendering berkualitas tinggi dengan detail presisi.</h4>
                    </div>
                </div>
                   <div className="flex flex-col md:flex-row justify-between mb-[100px]">
                    <div className='w-96'>
                        ...
                        <div className="w-full h-[1px] bg-gray-400 mt-2 mb-8"></div>
                        <h3 className='text-[2em] mb-8'>Tim Profesional</h3>
                        <h4>Desainer kami berpengalaman dalam menciptakan konsep visual yang inovatif dan estetis.</h4>
                    </div>
                    <div className='w-96'>
                        <h4 className='text-gray-400 mb-8'>05</h4>
                        <div className="w-full h-[1px] bg-gray-400 mt-2 mb-8"></div>
                        <h3 className='text-[2em] mb-8'>Akurasi</h3>
                        <h4>Desain 3D memungkinkan klien memvisualisasikan acara sebelum pelaksanaan, meminimalkan revisi.</h4>
                    </div>
                    <div className='w-96'>
                        <h4 className='text-gray-400 mb-8'>06</h4>
                        <div className="w-full h-[1px] bg-gray-400 mt-2 mb-8"></div>
                        <h3 className='text-[2em] mb-8'>Beragam Aplikasi</h3>
                        <h4>Mendukung berbagai jenis acara, seperti konser, konferensi, peluncuran produk, atau instalasi seni.</h4>
                    </div>
                </div>
            </div>
            <Imagesdesign />
